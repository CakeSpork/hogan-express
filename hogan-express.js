...
(function() {
	var $, cache, ctx, customContent, hogan, read, render, renderLayout, renderPartials, __hasProp = {}.hasOwnProperty, __extends = function(
			child, parent) {
		...
		_fn = function(name, lambda) {
			return opt.lambdas[name] = function() {
				...
				return function(text) {
					...
					return lambda(hogan.compile(text).render(lctx), hogan, lctx);
				};
			};
		};
		for (name in lambdas) {
